...
=======
        ...
        <div class="usage">
          <h1>Color</h1>
          <div id="energie">
            <input type="checkbox" name="box8" value="vbc" />Green
            <br />
            <input type="checkbox" name="box9" value="bvc" /> Yellow
            <br />
            <input type="checkbox" name="box10" value="bvc" />Red
            <br />
          </div>
        </div>
...
import List from "../components/FilterableList";
